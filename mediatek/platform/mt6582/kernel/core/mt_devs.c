...
#ifdef RGK_82M_SUPPORT_HD//lisong 2013-4-3 [NO BUGID][add for 82M support HD]start
unsigned int k_spare0 = 0;
unsigned int k_spare1 = 0;
#endif//lisong 2013-4-3 [NO BUGID][add for 82M support HD]end
...
#ifdef RGK_82M_SUPPORT_HD//lisong 2013-4-3 [NO BUGID][add for 82M support HD]start
        if ((br_ptr = strstr(*cmdline, "lk_spare0=")) != 0) 
        {		
            char strtemp[200] = {0};
			strcpy(strtemp,br_ptr+10);
            k_spare0 = (unsigned int)simple_strtoul(strtemp, NULL, 0);
		}
        if ((br_ptr = strstr(*cmdline, "lk_spare1=")) != 0) 
        {		
			char strtemp[200] = {0};
			strcpy(strtemp,br_ptr+10);
            k_spare1 = (unsigned int)simple_strtoul(strtemp, NULL, 0);
		}    
#endif//lisong 2013-4-3 [NO BUGID][add for 82M support HD]end
