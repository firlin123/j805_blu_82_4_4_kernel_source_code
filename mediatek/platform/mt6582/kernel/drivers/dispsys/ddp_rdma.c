...
extern unsigned int k_spare0;
extern unsigned int k_spare1;
...
#ifdef RGK_82M_SUPPORT_HD//lisong 2013-4-3 [NO BUGID][add for 82M support HD]start
    if(1)//((k_spare0 == 82)&&(k_spare1 == 380))//82M
    {
...
#ifdef RGK_82M_SUPPORT_HD//lisong 2013-4-3 [NO BUGID][add for 82M support HD]start
    if(1)//((k_spare0 == 82)&&(k_spare1 == 380))//82M
        DISP_REG_SET_FIELD(SIZE_CON_1_FLD_OUTPUT_FRAME_HEIGHT, idx * DISP_INDEX_OFFSET + DISP_REG_RDMA_SIZE_CON_1, 1440);
    else
