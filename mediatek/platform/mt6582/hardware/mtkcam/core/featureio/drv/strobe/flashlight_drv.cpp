...
StrobeDrv::FLASHLIGHT_TYPE_ENUM FlashlightDrv::getFlashlightType() const
{
    ...
    //lihua 2013-11-13 [BUG_ID:NULL] [Description:Porting flashlight driver from 89 to 82 platform flashlight can't work] start
/*
...
*/
    ...
    else if(e_CAMERA_SUB_SENSOR==m_sensorDev)
    {
        ...
        return FLASHLIGHT_NONE;
    //lihua 2013-11-13 [BUG_ID:NULL] [Description:Porting flashlight driver from 89 to 82 platform flashlight can't work] end
}
