...
CUSTOM_HAL_IMGSENSOR=ov8825_mipi_raw imx179_mipi_raw_2lane gc2035_yuv gc0329_yuv
...
CUSTOM_KERNEL_IMGSENSOR=ov8825_mipi_raw imx179_mipi_raw_2lane gc2035_yuv gc0329_yuv
...
CUSTOM_LK_LCM=hx8389b_dsi_vdo_txd_qhd hx8394_dsi_vdo_txd_ips_hd nt35521_dsi_auo_by_hd otm1283a_dsi_vdo_hlt_hd otm1283a_dsi_vdo_djn_hd #otm9605a_dsi_vdo_djn_qhd
...
#M BUG_ID:JBLWKK-314 zhaobeidou 20141106 (start)
...
RESOURCE_OVERLAY_SUPPORT=sd_in_ex_otg generic FWVGA 
...
CUSTOM_MODEM=rf9810_gsm4_w1258_mt6582_hspa_gemini
...
CUSTOM_KERNEL_LCM=hx8389b_dsi_vdo_txd_qhd hx8394_dsi_vdo_txd_ips_hd nt35521_dsi_auo_by_hd otm1283a_dsi_vdo_hlt_hd otm1283a_dsi_vdo_djn_hd #otm9605a_dsi_vdo_djn_qhd

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=hx8389b_dsi_vdo_txd_qhd hx8394_dsi_vdo_txd_ips_hd nt35521_dsi_auo_by_hd otm1283a_dsi_vdo_hlt_hd otm1283a_dsi_vdo_djn_hd #otm9605a_dsi_vdo_djn_qhd
...
#modify tianchunming BUG_ID:JBLW-585 (start)
#MTK_PRODUCT_LOCALES=ru_RU en_US uk_UA
MTK_PRODUCT_LOCALES=en_US es_ES pt_PT pt_BR nl_NL zh_CN zh_TW fr_FR de_DE hu_HU cs_CZ ar_EG fa_IR sr_RS bg_BG pl_PL ru_RU sr_RS iw_IL bg_BG
#modify tianchunming BUG_ID:JBLW-585 (end)
...
# User can input ASCII string which is showed in About phone and bootimg header.
CUSTOM_BUILD_VERNO=BLU-D650a-i-V32-GENERIC
FOTA_PRODUCT_MODEL=BLU-D650a-i-GENERIC
# add for internal verno customization by jinhaijian showed in 9375
CUSTOM_INTERNAL_BUILD_VERNO= J805_BLU_KK_A1A_V0.0.63_S1219
...
RGK_INTERNAL_SD_VOLUME_NAME = BLU
RGK_MTP_LABEL = STUDIO6.0HD
RGK_PTP_LABEL = STUDIO6.0HD
#add BUG_ID:DELQ-183 zengchuiguo 20130830 (end)

#modify BUG_ID:JWLW-1205 zengchuiguo 20140125 (start)
RGK_USB_DRIVER_DISPLAY_MANUFACTURER = BLU
...
RGK_USB_DRIVER_DISPLAY_PRODUCT_PART1 = STUDIO6.0HD
...
RGK_FOR_PLAYSTORE_ISSUE=yes
#A: }

#yangjuwei 2014-6-5 [NO BUGID][82M SUPPORT HD]start
RGK_82M_SUPPORT_HD=yes
#yangjuwei 2014-6-5 [NO BUGID][82M SUPPORT HD]end
...
RGK_PREINSTALL_GMS = yes
# jinhaijian }

#add JWLW-84 songqingming 20130916 (start)
RGK_POSITIVO_MATCH_NUMBER_SUPPORT = yes
