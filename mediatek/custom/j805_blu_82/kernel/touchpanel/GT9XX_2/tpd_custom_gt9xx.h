...
#define VKEY_X_INDEX 	0
#define VKEY_Y_INDEX 	1
#define VKEY_HEIGHT_INDEX	2
#define key_1           60,1000              //auto define  
#define key_2           240,1000
#define key_3           420,1000
#define key_4           480,1000

//#define TPD_KEYS        {KEY_MENU, KEY_HOMEPAGE,KEY_BACK , KEY_SEARCH}
#define TPD_KEYS        {KEY_BACK , KEY_HOMEPAGE,KEY_MENU, KEY_SEARCH}//change key_back key_menu
...
0x41,0x1C,0x02,0xC0,0x03,0x05,0x34,0xC1,0x00,0x08,\
0x19,0x5A,0x46,0x32,0x03,0x05,0x00,0x00,0x00,0x00,\
0x02,0x00,0x00,0x16,0x17,0x1E,0x14,0x8B,0x0A,0x0C,\
0x28,0x00,0x0C,0x08,0x00,0x00,0x00,0x02,0x03,0x1D,\
0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x19,0x64,0x94,0xC5,0x02,0x08,0x00,0x00,0x04,\
0xAF,0x1C,0x00,0x85,0x26,0x00,0x6A,0x32,0x00,0x56,\
0x42,0x00,0x48,0x57,0x00,0x48,0x10,0x30,0x58,0x00,\
0x56,0x45,0x30,0xFF,0xF0,0x27,0x00,0x00,0x00,0x00,\
...
0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0x11,0x11,0x11,0x11,\
0x41,0xFF,0xFF,0xFF,0xEF,0x01\
 }

// TODO: define your config for Sensor_ID == 1 here, if needed
// also for HeLiTai ,same to CTP_CFG_GROUP1, need to be checked ,anxiang.xiao 20131114
...
0x41,0xD0,0x02,0x00,0x05,0x05,0x34,0xC1,0x00,0x08,\
0x14,0x5A,0x46,0x32,0x03,0x05,0x00,0x00,0x00,0x00,\
0x04,0x00,0x00,0x17,0x19,0x1E,0x14,0x8B,0x0A,0x0C,\
0x28,0x00,0xF4,0x0A,0x00,0x00,0x00,0x03,0x02,0x1D,\
0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x14,0x3C,0x94,0xC5,0x02,0x08,0x00,0x00,0x04,\
0xD3,0x16,0x00,0xB4,0x1B,0x00,0x91,0x22,0x00,0x79,\
0x2B,0x00,0x66,0x36,0x00,0x66,0x10,0x30,0x58,0x00,\
0x56,0x45,0x30,0xFF,0xF0,0x17,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x18,0x16,0x14,0x12,0x10,0x0E,0x0C,0x0A,\
0x08,0x06,0x04,0x02,0xFF,0xFF,0x00,0x00,0x00,0x00,\
...
// STEP_3(optional):Custom set some config by themself,if need.
 ...
 #else
static int GTP_MAX_HEIGHT=960;    
static int GTP_MAX_WIDTH=540;
  #define GTP_INT_TRIGGER  0    //0:Rising 1:Falling
 #endif
#else 
