...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xf8 , 0x83);//84
	GC2035_write_cmos_sensor(0xfe , 0x00);
...
//	GC2035_write_cmos_sensor(0x0e , 0x21);//
...
////Record date: 2013-11-06 14:59:33
	GC2035_write_cmos_sensor(0xfe, 0x01);
	GC2035_write_cmos_sensor(0xc2, 0x39);
	GC2035_write_cmos_sensor(0xc3, 0x23);
	GC2035_write_cmos_sensor(0xc4, 0x1c);
	GC2035_write_cmos_sensor(0xc8, 0x3a);
	GC2035_write_cmos_sensor(0xc9, 0x2b);
	GC2035_write_cmos_sensor(0xca, 0x24);
	GC2035_write_cmos_sensor(0xbc, 0x7c);
	GC2035_write_cmos_sensor(0xbd, 0x55);
	GC2035_write_cmos_sensor(0xbe, 0x51);
	GC2035_write_cmos_sensor(0xb6, 0x79);
	GC2035_write_cmos_sensor(0xb7, 0x51);
	...
	GC2035_write_cmos_sensor(0xc0, 0x1c);
	GC2035_write_cmos_sensor(0xc1, 0x17);
	GC2035_write_cmos_sensor(0xb9, 0x09);
	GC2035_write_cmos_sensor(0xba, 0x14);
	GC2035_write_cmos_sensor(0xbb, 0x17);
	GC2035_write_cmos_sensor(0xaa, 0x35);
	GC2035_write_cmos_sensor(0xab, 0x24);
	GC2035_write_cmos_sensor(0xac, 0x2e);
	GC2035_write_cmos_sensor(0xad, 0x2a);
	GC2035_write_cmos_sensor(0xae, 0x18);
	GC2035_write_cmos_sensor(0xaf, 0x17);
	GC2035_write_cmos_sensor(0xb0, 0x26);
	GC2035_write_cmos_sensor(0xb1, 0x1e);
	GC2035_write_cmos_sensor(0xb2, 0x1b);
	GC2035_write_cmos_sensor(0xb3, 0x21);
	GC2035_write_cmos_sensor(0xb4, 0x15);
	GC2035_write_cmos_sensor(0xb5, 0x1f);
	GC2035_write_cmos_sensor(0xd0, 0x20);
	GC2035_write_cmos_sensor(0xd2, 0x08);
	GC2035_write_cmos_sensor(0xd3, 0x00);
	GC2035_write_cmos_sensor(0xd8, 0x2f);
	GC2035_write_cmos_sensor(0xda, 0x00);
	GC2035_write_cmos_sensor(0xdb, 0x00);
	GC2035_write_cmos_sensor(0xdc, 0x0d);
	GC2035_write_cmos_sensor(0xde, 0x00);
	GC2035_write_cmos_sensor(0xdf, 0x12);
	...
	GC2035_write_cmos_sensor(0xfe, 0x01);
	GC2035_write_cmos_sensor(0xc2, 0x33);
	GC2035_write_cmos_sensor(0xc3, 0x23);
	GC2035_write_cmos_sensor(0xc4, 0x1c);
	GC2035_write_cmos_sensor(0xc8, 0x33);
	GC2035_write_cmos_sensor(0xc9, 0x2b);
	GC2035_write_cmos_sensor(0xca, 0x24);
	GC2035_write_cmos_sensor(0xbc, 0x67);
	GC2035_write_cmos_sensor(0xbd, 0x55);
	GC2035_write_cmos_sensor(0xbe, 0x51);
	GC2035_write_cmos_sensor(0xb6, 0x5b);
	GC2035_write_cmos_sensor(0xb7, 0x51);
	...
	GC2035_write_cmos_sensor(0xcc, 0x00);
	GC2035_write_cmos_sensor(0xcd, 0x00);
	GC2035_write_cmos_sensor(0xbf, 0x41);
	GC2035_write_cmos_sensor(0xc0, 0x1c);
	GC2035_write_cmos_sensor(0xc1, 0x17);
	GC2035_write_cmos_sensor(0xb9, 0x0d);
	GC2035_write_cmos_sensor(0xba, 0x00);
	GC2035_write_cmos_sensor(0xbb, 0x20);
	GC2035_write_cmos_sensor(0xaa, 0x0d);
	GC2035_write_cmos_sensor(0xab, 0x04);
	GC2035_write_cmos_sensor(0xac, 0x0f);
	GC2035_write_cmos_sensor(0xad, 0x2e);
	GC2035_write_cmos_sensor(0xae, 0x10);
	GC2035_write_cmos_sensor(0xaf, 0x17);
	GC2035_write_cmos_sensor(0xb0, 0x27);
	GC2035_write_cmos_sensor(0xb1, 0x27);
	GC2035_write_cmos_sensor(0xb2, 0x21);
	GC2035_write_cmos_sensor(0xb3, 0x21);
	GC2035_write_cmos_sensor(0xb4, 0x15);
	GC2035_write_cmos_sensor(0xb5, 0x1f);
	GC2035_write_cmos_sensor(0xd0, 0x27);
	GC2035_write_cmos_sensor(0xd2, 0x08);
	GC2035_write_cmos_sensor(0xd3, 0x00);
	GC2035_write_cmos_sensor(0xd8, 0x2f);
	GC2035_write_cmos_sensor(0xda, 0x00);
	GC2035_write_cmos_sensor(0xdb, 0x00);
	GC2035_write_cmos_sensor(0xdc, 0x08);
	GC2035_write_cmos_sensor(0xde, 0x00);
	GC2035_write_cmos_sensor(0xdf, 0x12);
	GC2035_write_cmos_sensor(0xd4, 0x00);
	GC2035_write_cmos_sensor(0xd6, 0x00);
	...
	GC2035_write_cmos_sensor(0xc4 , 0xf8);
	...
	GC2035_write_cmos_sensor(0x56 , 0x06);//00 02 
	GC2035_write_cmos_sensor(0x57 , 0x20); //pre adjust
	GC2035_write_cmos_sensor(0x58 , 0x01); 
	GC2035_write_cmos_sensor(0x5b , 0x02); //AWB_gain_delta 08
...
//	GC2035_write_cmos_sensor(0x84, 0x0a);  
	...
	GC2035_write_cmos_sensor(0x89 , 0x75);//73
	...
	GC2035_write_cmos_sensor(0xd3 , 0x38);//contrast      peter  40
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->PreviewDelayFrame = 6; //2
...
BOOL GC2035_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AWB_MODE_CLOUDY_DAYLIGHT: //cloudy   
			...
			GC2035_write_cmos_sensor(0xb3, 0x50);//5a
			GC2035_write_cmos_sensor(0xb4, 0x40);//40
			GC2035_write_cmos_sensor(0xb5, 0x40);//51
		break;
		case AWB_MODE_DAYLIGHT: //ÈÕ¹â   
			GC2035_set_AWB_mode(KAL_FALSE);
			GC2035_write_cmos_sensor(0xb3, 0x5a);//70//50
			GC2035_write_cmos_sensor(0xb4, 0x40);//40
			GC2035_write_cmos_sensor(0xb5, 0x51);//40
		break;
		case AWB_MODE_INCANDESCENT: //°×³ãµÆ
			GC2035_set_AWB_mode(KAL_FALSE);
			GC2035_write_cmos_sensor(0xb3, 0x52);
			GC2035_write_cmos_sensor(0xb4, 0x40);
			GC2035_write_cmos_sensor(0xb5, 0xa4);
		break;
		case AWB_MODE_TUNGSTEN: //ÎÙË¿µÆ
			GC2035_set_AWB_mode(KAL_FALSE);
			GC2035_write_cmos_sensor(0xb3, 0x90);//a0
			GC2035_write_cmos_sensor(0xb4, 0x50);//40
			GC2035_write_cmos_sensor(0xb5, 0x40);
		break;
		case AWB_MODE_FLUORESCENT:
			GC2035_set_AWB_mode(KAL_FALSE);//Ó«¹â
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    ...
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x2c,0x2e);
		GC2035_write_cmos_sensor(0x2d,0x04);//6e8//level3  6e0//56f
		GC2035_write_cmos_sensor(0x2e,0x99);//a2
		GC2035_write_cmos_sensor(0x2f,0x0a);//level4
		GC2035_write_cmos_sensor(0x30,0x08);
		GC2035_SET_PAGE0;
            break;
		...
		GC2035_write_cmos_sensor(0x29,0x03);//level1
		GC2035_write_cmos_sensor(0x2a,0x70);
		GC2035_write_cmos_sensor(0x2b,0x03);//level2
		GC2035_write_cmos_sensor(0x2c,0x70);
		GC2035_write_cmos_sensor(0x2d,0x04);//level3
		GC2035_write_cmos_sensor(0x2e,0x20);
...
case AE_EV_COMP_00:
GC2035_SET_PAGE1;
GC2035_write_cmos_sensor(0x13,0x88);//88
GC2035_SET_PAGE0;
break;
/* case AE_EV_COMP_03:
GC2035_SET_PAGE1;
