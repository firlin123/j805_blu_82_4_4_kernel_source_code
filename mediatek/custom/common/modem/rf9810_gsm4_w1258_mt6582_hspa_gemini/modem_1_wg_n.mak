...
# Generated at 2014-02-22 02:09:57
...
# ------------------------------ Verno information
# VERNO = MOLY.WR8.W1315.MD.WG.MP.V34.P3
VERNO = RF9810_GSM4_W1258_MT6582_MP_V0.0.2_S0609
BUILD = BUILD_NO
...
BOARD_VER = RATECH82_CWET_RGK_KK_BB
  # Description:
...
PROJECT_MAKEFILE_EXT = RATECH82_CWET_RGK_KK_HSPA_EXT
include make/custom_config/$(strip $(PROJECT_MAKEFILE_EXT)).mak

# *************************************************************************
# Ragentek custom options penny add 140227 begin
# *************************************************************************
RAGENTEK_PROJECT = RF9810_GSM4_W1258_MT6582

# *************************************************************************
# Ragentek custom options penny add 140227 end
# *************************************************************************
